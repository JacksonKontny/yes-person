...
from src.env import APPROVAL_USERS, REPO_OWNER, APPROVALS_REQUIRED, INTERVAL_IN_SECONDS, TITLE_REGEX, REPO
...
def run():
    while True:
        ...
        prs_to_approve = [
            ...
            if should_approve_pull(pr, APPROVAL_USERS, APPROVALS_REQUIRED)
        ]
